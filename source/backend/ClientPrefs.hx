...
class ClientPrefs
{
	...
	{
		FlxG.sound.muteKeys = keyBinds.get('volume_mute').copy();
		FlxG.sound.volumeDownKeys = keyBinds.get('volume_down').copy();
		FlxG.sound.volumeUpKeys = keyBinds.get('volume_up').copy();
		toggleVolumeKeys(true);
	}

	public static function toggleVolumeKeys(have:Bool = true)
	{
		if (have)
		{
			FlxG.sound.muteKeys = keyBinds.get('volume_mute').copy();
